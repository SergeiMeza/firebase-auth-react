...
export {
  ...
  useDeleteUser,
  useFetchSignInMethodsForEmail,
  useGetAdditionalUserInfo,
  useGetRedirectResult,
  useIsSignInWithEmailLink,
  useLinkWithCredential,
  useLinkWithPhoneNumber,
  useLinkWithPopup,
  useLinkWithRedirect,
  useReauthenticateWithCredential,
  useReauthenticateWithPhoneNumber,
  useReauthenticateWithPopup,
  useReauthenticateWithRedirect,
  useReload,
